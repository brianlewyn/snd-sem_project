...
public class StoreMenu {
    ...
    public void displayMenu(){
        ...
        do{ 
            ...
            try{
                switch(readOption()){
                case 1: displayClientMenu(); break;
                case 2: displayProviderMenu(); break;
                case 3: displayProductMenu(); break;
                ...
                System.out.println("Ups, something has ocurred " +e2); sc.nextLine();
    ...
    public void displayClientMenu(){
        ...
        do{
            ...
            try{
                ...
                case 2: remove(clients); break;
                case 3: consultAll(clients); break;
                case 4: consultType(clients); break;
                case 5: modifyClient(); break;          
                case 6: sortByAlphabet(clients); break;
    ...
    public void displayProviderMenu(){ 
        ...
        do{
            ...
            try{
                ...
                case 2: remove(providers); break;
                case 3: consultAll(providers); break;
                case 4: consultType(providers); break;
                case 5: modifyProvider(); break;
                case 6: sortByAlphabet(providers); break;
                case 7: Exit = true; break;
                default: 
                    throw new OutOfRangeException();
                }
    ...
    public void displayProductMenu(){
        ...
        do{
            try{
                ...
                case 3: consultAll(products); break;
                case 4: consultProduct(); break;
                case 5: modifyProduct(); break; 
                case 6: sortByAlphabet(products); break;
    ...
    private void addProduct() throws Exception {
        ...
        do {
            ...
            try{
                switch(readOption()){
                case 1: addElectronicProduct(); break;
                case 2: addNonElectronicProduct(); break;
    ...
    private void addElectronicProduct() throws Exception {
        ...
        float discount = readFloat("\nSet the discount of the product:"); sc.nextLine();
            ...
            try{
                ...
                default:
                    if (isElectronic){
                        switch(option){
                        case 6:
                            products.modifyElectronic(code).setSerial(readLong("\nWrite down the new SerialNumber of the product:"));
