...
public class Clients implements ArrayController, SubjectController, Serializable {
    ...
    public Clients(Client[] clientArray) {
    ...
    // acts as get method, in order to get the client and then change a specific
    // atribute
